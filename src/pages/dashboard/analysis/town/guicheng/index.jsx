...
const content1 = (
    <div className={styles.popwidth}>
        <Row gutter={8}>
            ...
            <Col span={7}>
                <Button style={{ marginRight: 8, marginTop: 8 }}>趋势详情</Button>
...
const city = [
    [<a href="#" target="_blank">平一泵站</a>],
    [<a href="#" target="_blank">平二泵站</a>],
    [<a href="#" target="_blank">平三泵站</a>],
    [<a href="#" target="_blank">平四泵站</a>],
    [<a href="#" target="_blank">平五泵站</a>],
    [<a href="#" target="_blank">平六泵站</a>],
    [<a href="#" target="_blank">石肯泵站</a>],
    [<a href="#" target="_blank">中途泵站</a>],
    [<a href="#" target="_blank">玉器街泵站</a>],
];
...
for (let i = 0; i < 5; i++) {
    data.push({
        ...
        location: city[randomInt(0, city.length)],
        alarmcontent: '电流过大',
        alarmlevel: (i % 3) + 1,
    });
}
            ...
            <span><BzMenuMini /></span></div>
                        ...
                        <div className={styles.rankingtitle}>
                            <Tabs onChange={callback} type="card" className={styles.analysis_rate}>
                                ...
                                <TabPane tab={<span style={{ fontSize: 14}}>累计流量</span>} key="b" className={styles.rate_title}>
                                    <div className={styles.analysis_rate_con}>
                                        <BzTotalVolume />
                                        <span className={styles.unit2}>单位：m³</span>
                                    </div>
                                </TabPane>
                                ...
                                <TabPane tab={<span style={{ fontSize: 14}}>PH值</span>} key="d" className={styles.rate_title}>
                                    <div className={styles.analysis_rate_con}>
                                        <BzTotalVolume />
                                        <span className={styles.unit2}>单位：ph</span>
                                    </div>
                                </TabPane>
                            </Tabs>
                ...
                <Col sm={24} md={24} lg={7} xl={6} xxl={5} >
                    <div className={styles.town_alarm_info}>
                        <h4>报警<span><a href="#" target="_blank">更多</a></span></h4>
                        <Table
                            columns={columns}
                            dataSource={data}
                            pagination={false}
